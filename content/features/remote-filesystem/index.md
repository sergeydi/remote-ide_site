...
<h2>Turn it on per remote path</h2>
...
{{< shot src="remote-ide-remote-filesystem-toggle.png" alt="New Remote Project dialog with the Use remote filesystem toggle switched on" >}}
</div>

<div class="feature-section-text">
<h2>Edit files where they actually live</h2>
...
<div class="feature-section-text">
<h2>No stale copies, no drift</h2>
