...
<h3>Guided setup if tmux isn't installed</h3>
...
<div class="feature-shot"><img src="remote-ide-tmux-install-guide.png" alt="In-app tmux info sheet with an About section and copy-paste install commands for Ubuntu, Debian, macOS, Fedora, CentOS, and Arch Linux"></div>
</div>

<div class="feature-section-text">
<h3>Sessions that outlive the app</h3>
...
<div class="feature-section-text">
<h3>Reattach exactly where you left off</h3>
