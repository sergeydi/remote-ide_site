...
[MCP Notes](https://mcp-notes.com), о котором шла речь выше, — активно разрабатываемое приложение с открытым исходным кодом ([репозиторий на GitHub](https://github.com/sergeydi/MCP-Notes)), и как раз на нём этот рабочий процесс обкатывается на практике день за днём.
