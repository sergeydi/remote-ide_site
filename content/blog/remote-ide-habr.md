...
date: 2026-05-13
description: "iPad получил нативную многооконность в iPadOS 26, а агентное программирование изменило характер работы с кодом. Рассказываю, почему именно сейчас iPad стал полноценным инструментом разработчика, и показываю Remote IDE — приложение с SSH-терминалом, редактором кода, SFTP и Git, созданное с нуля под эти возможности."
---
