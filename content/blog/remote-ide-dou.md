...
date: 2026-05-14
description: "iPad отримав нативну багатовіконність в iPadOS 26, а агентне програмування змінило сам характер роботи з кодом. Розповідаю, чому саме зараз iPad став повноцінним інструментом розробника, і показую Remote IDE — застосунок із SSH-терміналом, редактором коду, SFTP та Git, створений з нуля під ці можливості."
---
